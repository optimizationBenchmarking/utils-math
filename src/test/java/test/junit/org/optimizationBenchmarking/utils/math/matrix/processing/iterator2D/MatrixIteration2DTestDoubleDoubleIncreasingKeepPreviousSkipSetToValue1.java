...
public class MatrixIteration2DTestDoubleDoubleIncreasingKeepPreviousSkipSetToValue1
    extends MatrixIteration2DTest {

  /** create */
  public MatrixIteration2DTestDoubleDoubleIncreasingKeepPreviousSkipSetToValue1() {
    super();
  }
  ...
  protected void setup(final MatrixIteration2DBuilder builder) {
    builder.setEndReplacement(Double.valueOf(-23.5d));
  ...
  protected void checkY(final int step, final AbstractMatrix y) {
    ...
    switch (step) {
      ...
      case 4: {
        Assert.assertEquals(y.n(), 2);
        Assert.assertEquals(-23.5d, y.getDouble(0, 0), Double.MIN_VALUE);
