...
/** test the long distance matrix */
public class LongDistanceMatrix1DBuilderTest
    extends LongDistanceMatrix1DTest {

  /** the constructor */
  public LongDistanceMatrix1DBuilderTest() {
    super();
  }
  ...
  private static final class __Builder extends DistanceMatrixBuilderJob {
    ...
    protected final void setDistance(final int i, final int j,
      ...
      appendTo.append(this.m_fullMatrix.getLong(i, j));
    }
