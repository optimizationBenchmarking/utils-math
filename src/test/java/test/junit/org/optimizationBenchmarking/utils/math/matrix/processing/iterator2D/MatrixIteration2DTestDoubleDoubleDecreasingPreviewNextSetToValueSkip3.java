...
public class MatrixIteration2DTestDoubleDoubleDecreasingPreviewNextSetToValueSkip3
    extends MatrixIteration2DTest {

  /** create */
  public MatrixIteration2DTestDoubleDoubleDecreasingPreviewNextSetToValueSkip3() {
    super();
  }
  ...
  protected void setup(final MatrixIteration2DBuilder builder) {
    ...
    builder.setStartReplacement(Double.valueOf(385.5d));
  ...
  protected void checkY(final int step, final AbstractMatrix y) {
    ...
    switch (step) {
      case 0: {
        ...
        Assert.assertEquals(385.5d, y.getDouble(0, 1), Double.MIN_VALUE);
        Assert.assertEquals(385.5d, y.getDouble(0, 2), Double.MIN_VALUE);
        Assert.assertEquals(385.5d, y.getDouble(0, 3), Double.MIN_VALUE);
        return;
      }
      case 1: {
        Assert.assertEquals(y.n(), 4);
