...
public class MatrixIteration2DTestDoubleDoubleIncreasingKeepPreviousSkipSetToValue5
    extends MatrixIteration2DTest {

  /** create */
  public MatrixIteration2DTestDoubleDoubleIncreasingKeepPreviousSkipSetToValue5() {
    super();
  }
  ...
  protected void setup(final MatrixIteration2DBuilder builder) {
    builder.setEndReplacement(Double.valueOf(-45.5d));
    ...
    builder.setNaNReplacementForYAxis(43d);
  ...
  protected void checkY(final int step, final AbstractMatrix y) {
    ...
    switch (step) {
      ...
      case 4: {
        ...
        Assert.assertEquals(-45.5d, y.getDouble(0, 1), Double.MIN_VALUE);
        return;
      }
      default: {
        throw new AssertionError("Only five steps allowed."); //$NON-NLS-1$
