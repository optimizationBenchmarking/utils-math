...
/** test the float distance matrix */
public class FloatDistanceMatrix1DBuilderTest
    extends FloatDistanceMatrix1DTest {

  /** the constructor */
  public FloatDistanceMatrix1DBuilderTest() {
    super();
  }
  ...
  private static final class __Builder extends DistanceMatrixBuilderJob {
    ...
    protected final void setDistance(final int i, final int j,
      ...
      appendTo.append((float) (this.m_fullMatrix.getDouble(i, j)));
    }
