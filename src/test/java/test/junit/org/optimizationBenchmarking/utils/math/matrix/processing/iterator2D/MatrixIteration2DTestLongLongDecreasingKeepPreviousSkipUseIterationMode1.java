...
public class MatrixIteration2DTestLongLongDecreasingKeepPreviousSkipUseIterationMode1
    extends MatrixIteration2DTest {

  /** create */
  public MatrixIteration2DTestLongLongDecreasingKeepPreviousSkipUseIterationMode1() {
    super();
  }
