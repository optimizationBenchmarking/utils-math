...
public class MatrixIteration2DTestDoubleDoubleDecreasingKeepPreviousSkipSetToValue2
    extends MatrixIteration2DTest {

  /** create */
  public MatrixIteration2DTestDoubleDoubleDecreasingKeepPreviousSkipSetToValue2() {
    super();
  }
  ...
  protected void setup(final MatrixIteration2DBuilder builder) {
    builder.setEndReplacement(Double.valueOf(123.5d));
  ...
  protected void checkY(final int step, final AbstractMatrix y) {
    ...
    switch (step) {
      ...
      case 6: {
        Assert.assertEquals(y.n(), 3);
        Assert.assertEquals(123.5d, y.getDouble(0, 0), Double.MIN_VALUE);
      ...
      case 7: {
        Assert.assertEquals(y.n(), 3);
        Assert.assertEquals(123.5d, y.getDouble(0, 0), Double.MIN_VALUE);
        Assert.assertEquals(123.5d, y.getDouble(0, 1), Double.MIN_VALUE);
