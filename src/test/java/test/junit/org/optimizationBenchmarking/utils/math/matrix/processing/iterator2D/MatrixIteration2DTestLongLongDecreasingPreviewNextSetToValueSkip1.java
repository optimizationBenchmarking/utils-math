...
public class MatrixIteration2DTestLongLongDecreasingPreviewNextSetToValueSkip1
    extends MatrixIteration2DTest {

  /** create */
  public MatrixIteration2DTestLongLongDecreasingPreviewNextSetToValueSkip1() {
    super();
  }
  ...
  protected void setup(final MatrixIteration2DBuilder builder) {
    ...
    builder.setStartReplacement(Long.valueOf(-31L));
  ...
  protected void checkY(final int step, final AbstractMatrix y) {
    ...
    switch (step) {
      case 0: {
        ...
        Assert.assertEquals(-31L, y.getLong(0, 1));
        return;
      }
      case 1: {
        Assert.assertEquals(y.n(), 2);
