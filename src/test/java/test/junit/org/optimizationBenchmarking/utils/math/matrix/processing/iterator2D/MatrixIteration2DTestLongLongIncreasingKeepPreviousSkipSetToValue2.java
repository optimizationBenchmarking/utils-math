...
public class MatrixIteration2DTestLongLongIncreasingKeepPreviousSkipSetToValue2
    extends MatrixIteration2DTest {

  /** create */
  public MatrixIteration2DTestLongLongIncreasingKeepPreviousSkipSetToValue2() {
    super();
  }
  ...
  protected void setup(final MatrixIteration2DBuilder builder) {
    builder.setEndReplacement(Long.valueOf(123L));
  ...
  protected void checkY(final int step, final AbstractMatrix y) {
    ...
    switch (step) {
      ...
      case 6: {
        Assert.assertEquals(y.n(), 3);
        Assert.assertEquals(123L, y.getLong(0, 0));
      ...
      case 7: {
        Assert.assertEquals(y.n(), 3);
        Assert.assertEquals(123L, y.getLong(0, 0));
        Assert.assertEquals(123L, y.getLong(0, 1));
