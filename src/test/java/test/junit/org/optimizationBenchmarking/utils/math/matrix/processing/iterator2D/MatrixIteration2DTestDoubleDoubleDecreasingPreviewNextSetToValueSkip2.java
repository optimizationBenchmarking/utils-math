...
public class MatrixIteration2DTestDoubleDoubleDecreasingPreviewNextSetToValueSkip2
    extends MatrixIteration2DTest {

  /** create */
  public MatrixIteration2DTestDoubleDoubleDecreasingPreviewNextSetToValueSkip2() {
    super();
  }
  ...
  protected void setup(final MatrixIteration2DBuilder builder) {
    ...
    builder.setStartReplacement(Double.valueOf(74.5d));
  ...
  protected void checkY(final int step, final AbstractMatrix y) {
    ...
    switch (step) {
      case 0: {
        ...
        Assert.assertEquals(74.5d, y.getDouble(0, 0), Double.MIN_VALUE);
        Assert.assertEquals(74.5d, y.getDouble(0, 1), Double.MIN_VALUE);
        Assert.assertEquals(999999.5d, y.getDouble(0, 2),
            Double.MIN_VALUE);
        Assert.assertEquals(74.5d, y.getDouble(0, 3), Double.MIN_VALUE);
        return;
      }
      case 1: {
        Assert.assertEquals(y.n(), 4);
        ...
        Assert.assertEquals(888888.5d, y.getDouble(0, 3),
            Double.MIN_VALUE);
        return;
      }
      case 2: {
      ...
      case 7: {
        ...
        Assert.assertEquals(9.5d, y.getDouble(0, 1), Double.MIN_VALUE);
        Assert.assertEquals(8.5d, y.getDouble(0, 2), Double.MIN_VALUE);
        return;
      }
      case 8: {
        Assert.assertEquals(y.n(), 2);
        Assert.assertEquals(9.5d, y.getDouble(0, 0), Double.MIN_VALUE);
        Assert.assertEquals(8.5d, y.getDouble(0, 1), Double.MIN_VALUE);
        return;
      }
      case 9: {
