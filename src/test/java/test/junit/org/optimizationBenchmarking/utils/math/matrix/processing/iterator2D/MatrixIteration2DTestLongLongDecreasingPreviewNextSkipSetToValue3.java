...
public class MatrixIteration2DTestLongLongDecreasingPreviewNextSkipSetToValue3
    extends MatrixIteration2DTest {

  /** create */
  public MatrixIteration2DTestLongLongDecreasingPreviewNextSkipSetToValue3() {
    super();
  }
  ...
  protected void setup(final MatrixIteration2DBuilder builder) {
    builder.setEndReplacement(Long.valueOf(10007L));
  ...
  protected void checkY(final int step, final AbstractMatrix y) {
    ...
    switch (step) {
      ...
      case 13: {
        Assert.assertEquals(y.n(), 4);
        Assert.assertEquals(10007L, y.getLong(0, 0));
        Assert.assertEquals(1300L, y.getLong(0, 1));
        Assert.assertEquals(140000L, y.getLong(0, 2));
        Assert.assertEquals(15000000L, y.getLong(0, 3));
        return;
      ...
      case 14: {
        Assert.assertEquals(y.n(), 4);
        Assert.assertEquals(10007L, y.getLong(0, 0));
        Assert.assertEquals(10007L, y.getLong(0, 1));
        Assert.assertEquals(140000L, y.getLong(0, 2));
        Assert.assertEquals(15000000L, y.getLong(0, 3));
        return;
      }
      case 15: {
        ...
        Assert.assertEquals(10007L, y.getLong(0, 0));
        Assert.assertEquals(10007L, y.getLong(0, 1));
        Assert.assertEquals(10007L, y.getLong(0, 2));
        Assert.assertEquals(15000000L, y.getLong(0, 3));
        return;
      }
