...
/** test the byte distance matrix */
public class ByteDistanceMatrix1DBuilderTest
    extends ByteDistanceMatrix1DTest {

  /** the constructor */
  public ByteDistanceMatrix1DBuilderTest() {
    super();
  }
  ...
  private static final class __Builder extends DistanceMatrixBuilderJob {
    ...
    protected final void setDistance(final int i, final int j,
      ...
      appendTo.append((byte) (this.m_fullMatrix.getLong(i, j)));
    }
