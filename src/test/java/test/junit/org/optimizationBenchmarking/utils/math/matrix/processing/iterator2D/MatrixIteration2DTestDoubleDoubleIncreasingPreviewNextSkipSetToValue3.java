...
public class MatrixIteration2DTestDoubleDoubleIncreasingPreviewNextSkipSetToValue3
    extends MatrixIteration2DTest {

  /** create */
  public MatrixIteration2DTestDoubleDoubleIncreasingPreviewNextSkipSetToValue3() {
    super();
  }
  ...
  protected void setup(final MatrixIteration2DBuilder builder) {
    builder.setEndReplacement(Double.valueOf(12345.5d));
  ...
  protected void checkY(final int step, final AbstractMatrix y) {
    ...
    switch (step) {
      ...
      case 13: {
        Assert.assertEquals(y.n(), 4);
        Assert.assertEquals(12345.5d, y.getDouble(0, 0), Double.MIN_VALUE);
        Assert.assertEquals(1300.5d, y.getDouble(0, 1), Double.MIN_VALUE);
        Assert.assertEquals(140000.5d, y.getDouble(0, 2),
            Double.MIN_VALUE);
        Assert.assertEquals(15000000.5d, y.getDouble(0, 3),
      ...
      case 14: {
        Assert.assertEquals(y.n(), 4);
        Assert.assertEquals(12345.5d, y.getDouble(0, 0), Double.MIN_VALUE);
        Assert.assertEquals(12345.5d, y.getDouble(0, 1), Double.MIN_VALUE);
        Assert.assertEquals(140000.5d, y.getDouble(0, 2),
            Double.MIN_VALUE);
        Assert.assertEquals(15000000.5d, y.getDouble(0, 3),
            Double.MIN_VALUE);
      ...
      case 15: {
        ...
        Assert.assertEquals(12345.5d, y.getDouble(0, 0), Double.MIN_VALUE);
        Assert.assertEquals(12345.5d, y.getDouble(0, 1), Double.MIN_VALUE);
        Assert.assertEquals(12345.5d, y.getDouble(0, 2), Double.MIN_VALUE);
        Assert.assertEquals(15000000.5d, y.getDouble(0, 3),
            Double.MIN_VALUE);
        return;
      }
