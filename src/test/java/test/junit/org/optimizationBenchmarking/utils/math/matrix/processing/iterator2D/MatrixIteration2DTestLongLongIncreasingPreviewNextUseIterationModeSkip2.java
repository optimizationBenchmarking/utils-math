...
public class MatrixIteration2DTestLongLongIncreasingPreviewNextUseIterationModeSkip2
    extends MatrixIteration2DTest {

  /** create */
  public MatrixIteration2DTestLongLongIncreasingPreviewNextUseIterationModeSkip2() {
    super();
  }
