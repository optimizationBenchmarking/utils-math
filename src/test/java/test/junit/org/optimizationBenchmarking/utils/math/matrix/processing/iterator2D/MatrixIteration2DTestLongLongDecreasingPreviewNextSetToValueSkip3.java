...
public class MatrixIteration2DTestLongLongDecreasingPreviewNextSetToValueSkip3
    extends MatrixIteration2DTest {

  /** create */
  public MatrixIteration2DTestLongLongDecreasingPreviewNextSetToValueSkip3() {
    super();
  }
  ...
  protected void setup(final MatrixIteration2DBuilder builder) {
    ...
    builder.setStartReplacement(Long.valueOf(385L));
  ...
  protected void checkY(final int step, final AbstractMatrix y) {
    ...
    switch (step) {
      case 0: {
        ...
        Assert.assertEquals(385L, y.getLong(0, 1));
        Assert.assertEquals(385L, y.getLong(0, 2));
        Assert.assertEquals(385L, y.getLong(0, 3));
        return;
      }
      case 1: {
        Assert.assertEquals(y.n(), 4);
      ...
      case 10: {
        Assert.assertEquals(y.n(), 4);
        Assert.assertEquals(12L, y.getLong(0, 0));
        Assert.assertEquals(1300L, y.getLong(0, 1));
        Assert.assertEquals(100000L, y.getLong(0, 2));
        Assert.assertEquals(11000000L, y.getLong(0, 3));
        return;
      }
      case 11: {
        ...
        Assert.assertEquals(12L, y.getLong(0, 0));
        Assert.assertEquals(1300L, y.getLong(0, 1));
        Assert.assertEquals(140000L, y.getLong(0, 2));
        Assert.assertEquals(11000000L, y.getLong(0, 3));
        return;
      }
      case 12: {
        ...
        Assert.assertEquals(1300L, y.getLong(0, 1));
        Assert.assertEquals(140000L, y.getLong(0, 2));
        Assert.assertEquals(15000000L, y.getLong(0, 3));
        return;
      }
      case 13: {
        Assert.assertEquals(y.n(), 3);
        Assert.assertEquals(1300L, y.getLong(0, 0));
        Assert.assertEquals(140000L, y.getLong(0, 1));
        Assert.assertEquals(15000000L, y.getLong(0, 2));
        return;
      }
      case 14: {
        Assert.assertEquals(y.n(), 2);
        Assert.assertEquals(140000L, y.getLong(0, 0));
        Assert.assertEquals(15000000L, y.getLong(0, 1));
        return;
      }
      case 15: {
