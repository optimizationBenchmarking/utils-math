...
public class MatrixIteration2DTestLongLongDecreasingKeepPreviousSkipUseIterationMode2
    extends MatrixIteration2DTest {

  /** create */
  public MatrixIteration2DTestLongLongDecreasingKeepPreviousSkipUseIterationMode2() {
    super();
  }
