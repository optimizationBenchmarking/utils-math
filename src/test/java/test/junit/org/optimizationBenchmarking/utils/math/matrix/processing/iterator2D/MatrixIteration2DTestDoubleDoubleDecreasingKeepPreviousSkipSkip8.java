...
public class MatrixIteration2DTestDoubleDoubleDecreasingKeepPreviousSkipSkip8
    extends MatrixIteration2DTest {

  /** create */
  public MatrixIteration2DTestDoubleDoubleDecreasingKeepPreviousSkipSkip8() {
    super();
  }
  ...
  protected void setup(final MatrixIteration2DBuilder builder) {
    ...
    builder.setNaNReplacementForYAxis(10.5d);
