...
public class MatrixIteration2DTestDoubleDoubleIncreasingPreviewNextSkipSetToValue1
    extends MatrixIteration2DTest {

  /** create */
  public MatrixIteration2DTestDoubleDoubleIncreasingPreviewNextSkipSetToValue1() {
    super();
  }
  ...
  protected void setup(final MatrixIteration2DBuilder builder) {
    builder.setEndReplacement(Double.valueOf(5555.5d));
  ...
  protected void checkY(final int step, final AbstractMatrix y) {
    ...
    switch (step) {
      ...
      case 4: {
        Assert.assertEquals(y.n(), 2);
        Assert.assertEquals(5555.5d, y.getDouble(0, 0), Double.MIN_VALUE);
