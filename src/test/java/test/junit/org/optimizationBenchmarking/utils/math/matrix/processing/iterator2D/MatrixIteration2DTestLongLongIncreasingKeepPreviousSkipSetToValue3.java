...
public class MatrixIteration2DTestLongLongIncreasingKeepPreviousSkipSetToValue3
    extends MatrixIteration2DTest {

  /** create */
  public MatrixIteration2DTestLongLongIncreasingKeepPreviousSkipSetToValue3() {
    super();
  }
  ...
  protected void setup(final MatrixIteration2DBuilder builder) {
    builder.setEndReplacement(Long.valueOf(27L));
  ...
  protected void checkY(final int step, final AbstractMatrix y) {
    ...
    switch (step) {
      ...
      case 13: {
        Assert.assertEquals(y.n(), 4);
        Assert.assertEquals(27L, y.getLong(0, 0));
      ...
      case 14: {
        Assert.assertEquals(y.n(), 4);
        Assert.assertEquals(27L, y.getLong(0, 0));
        Assert.assertEquals(27L, y.getLong(0, 1));
      ...
      case 15: {
        ...
        Assert.assertEquals(27L, y.getLong(0, 0));
        Assert.assertEquals(27L, y.getLong(0, 1));
        Assert.assertEquals(27L, y.getLong(0, 2));
