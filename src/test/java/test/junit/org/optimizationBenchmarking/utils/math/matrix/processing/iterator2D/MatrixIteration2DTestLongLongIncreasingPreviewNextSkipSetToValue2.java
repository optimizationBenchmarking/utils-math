...
public class MatrixIteration2DTestLongLongIncreasingPreviewNextSkipSetToValue2
    extends MatrixIteration2DTest {

  /** create */
  public MatrixIteration2DTestLongLongIncreasingPreviewNextSkipSetToValue2() {
    super();
  }
  ...
  protected void setup(final MatrixIteration2DBuilder builder) {
    builder.setEndReplacement(Long.valueOf(64L));
  ...
  protected void checkY(final int step, final AbstractMatrix y) {
    ...
    switch (step) {
      ...
      case 6: {
        Assert.assertEquals(y.n(), 3);
        Assert.assertEquals(64L, y.getLong(0, 0));
      ...
      case 7: {
        Assert.assertEquals(y.n(), 3);
        Assert.assertEquals(64L, y.getLong(0, 0));
        Assert.assertEquals(64L, y.getLong(0, 1));
        Assert.assertEquals(9L, y.getLong(0, 2));
        return;
      }
      default: {
