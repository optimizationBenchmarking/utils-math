...
public class MatrixIteration2DTestDoubleDoubleIncreasingPreviewNextSkipSetToValue2
    extends MatrixIteration2DTest {

  /** create */
  public MatrixIteration2DTestDoubleDoubleIncreasingPreviewNextSkipSetToValue2() {
    super();
  }
  ...
  protected void setup(final MatrixIteration2DBuilder builder) {
    builder.setEndReplacement(Double.valueOf(64.5d));
  ...
  protected void checkY(final int step, final AbstractMatrix y) {
    ...
    switch (step) {
      ...
      case 6: {
        Assert.assertEquals(y.n(), 3);
        Assert.assertEquals(64.5d, y.getDouble(0, 0), Double.MIN_VALUE);
      ...
      case 7: {
        Assert.assertEquals(y.n(), 3);
        Assert.assertEquals(64.5d, y.getDouble(0, 0), Double.MIN_VALUE);
        Assert.assertEquals(64.5d, y.getDouble(0, 1), Double.MIN_VALUE);
        Assert.assertEquals(9.5d, y.getDouble(0, 2), Double.MIN_VALUE);
        return;
      }
      default: {
