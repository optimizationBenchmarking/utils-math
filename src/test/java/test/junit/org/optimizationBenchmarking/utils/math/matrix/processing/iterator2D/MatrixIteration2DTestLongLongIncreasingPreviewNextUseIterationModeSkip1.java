...
public class MatrixIteration2DTestLongLongIncreasingPreviewNextUseIterationModeSkip1
    extends MatrixIteration2DTest {

  /** create */
  public MatrixIteration2DTestLongLongIncreasingPreviewNextUseIterationModeSkip1() {
    super();
  }
