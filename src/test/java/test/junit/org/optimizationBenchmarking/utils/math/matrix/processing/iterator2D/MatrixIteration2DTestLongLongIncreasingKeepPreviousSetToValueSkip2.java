...
public class MatrixIteration2DTestLongLongIncreasingKeepPreviousSetToValueSkip2
    extends MatrixIteration2DTest {

  /** create */
  public MatrixIteration2DTestLongLongIncreasingKeepPreviousSetToValueSkip2() {
    super();
  }
  ...
  protected void setup(final MatrixIteration2DBuilder builder) {
    ...
    builder.setStartReplacement(Long.valueOf(678L));
  ...
  protected void checkY(final int step, final AbstractMatrix y) {
    ...
    switch (step) {
      case 0: {
        ...
        Assert.assertEquals(678L, y.getLong(0, 1));
        Assert.assertEquals(678L, y.getLong(0, 2));
        Assert.assertEquals(678L, y.getLong(0, 3));
        return;
      }
      case 1: {
        Assert.assertEquals(y.n(), 4);
