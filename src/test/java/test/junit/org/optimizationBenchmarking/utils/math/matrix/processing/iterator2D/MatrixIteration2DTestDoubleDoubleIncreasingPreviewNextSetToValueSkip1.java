...
public class MatrixIteration2DTestDoubleDoubleIncreasingPreviewNextSetToValueSkip1
    extends MatrixIteration2DTest {

  /** create */
  public MatrixIteration2DTestDoubleDoubleIncreasingPreviewNextSetToValueSkip1() {
    super();
  }
  ...
  protected void setup(final MatrixIteration2DBuilder builder) {
    ...
    builder.setStartReplacement(Double.valueOf(44444.5d));
  ...
  protected void checkY(final int step, final AbstractMatrix y) {
    ...
    switch (step) {
      case 0: {
        ...
        Assert.assertEquals(44444.5d, y.getDouble(0, 0), Double.MIN_VALUE);
        Assert.assertEquals(44444.5d, y.getDouble(0, 1), Double.MIN_VALUE);
