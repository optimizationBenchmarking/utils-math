...
public class MatrixIteration2DTestDoubleDoubleDecreasingPreviewNextSkipSetToValue2
    extends MatrixIteration2DTest {

  /** create */
  public MatrixIteration2DTestDoubleDoubleDecreasingPreviewNextSkipSetToValue2() {
    super();
  }
  ...
  protected void setup(final MatrixIteration2DBuilder builder) {
    builder.setEndReplacement(Double.valueOf(-321.5d));
    ...
    builder.setMatrices(//
        ...
        new DoubleMatrix1D(new double[] { //
            Double.POSITIVE_INFINITY, 999999.5d, //
            3.5d, 99999.5d, //
            2.5d, 9999.5d, //
            1.5d, 999.5d, //
            0.5d, 99.5d, //
            Double.NEGATIVE_INFINITY, 9.5d,//
    }, 6, 2), //
        new DoubleMatrix1D(new double[] { //
            Math.nextAfter(Double.POSITIVE_INFINITY,
            ...
            1.5d, 888.5d, //
            0.5d, 88.5d, //
            Math.nextAfter(Double.NEGATIVE_INFINITY,
    ...
    switch (step) {
      ...
      case 1: {
        Assert.assertEquals(
            Math.nextAfter(Double.POSITIVE_INFINITY,
                Double.NEGATIVE_INFINITY),
            x.doubleValue(), Double.MIN_VALUE);
        return;
      }
      case 2: {
  ...
  protected void checkY(final int step, final AbstractMatrix y) {
    ...
    switch (step) {
      case 0: {
        ...
        Assert.assertEquals(999999.5d, y.getDouble(0, 0),
            Double.MIN_VALUE);
        return;
      }
      case 1: {
        Assert.assertEquals(y.n(), 2);
        Assert.assertEquals(99999.5d, y.getDouble(0, 0), Double.MIN_VALUE);
        Assert.assertEquals(888888.5d, y.getDouble(0, 1),
            Double.MIN_VALUE);
        return;
      }
      case 2: {
        ...
        Assert.assertEquals(99999.5d, y.getDouble(0, 1), Double.MIN_VALUE);
        Assert.assertEquals(88888.5d, y.getDouble(0, 2), Double.MIN_VALUE);
        return;
      }
      case 3: {
        ...
        Assert.assertEquals(88888.5d, y.getDouble(0, 3), Double.MIN_VALUE);
        return;
      }
      case 4: {
        Assert.assertEquals(y.n(), 4);
        ...
        Assert.assertEquals(8888.5d, y.getDouble(0, 3), Double.MIN_VALUE);
        return;
      }
      case 5: {
        Assert.assertEquals(y.n(), 4);
        ...
        Assert.assertEquals(888.5d, y.getDouble(0, 3), Double.MIN_VALUE);
        return;
      }
      case 6: {
        Assert.assertEquals(y.n(), 4);
        ...
        Assert.assertEquals(88.5d, y.getDouble(0, 3), Double.MIN_VALUE);
        return;
      }
      case 7: {
        Assert.assertEquals(y.n(), 4);
        Assert.assertEquals(-321.5d, y.getDouble(0, 0), Double.MIN_VALUE);
        Assert.assertEquals(600.5d, y.getDouble(0, 1), Double.MIN_VALUE);
        Assert.assertEquals(9.5d, y.getDouble(0, 2), Double.MIN_VALUE);
        Assert.assertEquals(8.5d, y.getDouble(0, 3), Double.MIN_VALUE);
        return;
      }
      case 8: {
        Assert.assertEquals(y.n(), 4);
      ...
      case 9: {
        ...
        Assert.assertEquals(-321.5d, y.getDouble(0, 1), Double.MIN_VALUE);
        Assert.assertEquals(9.5d, y.getDouble(0, 2), Double.MIN_VALUE);
        Assert.assertEquals(-321.5d, y.getDouble(0, 3), Double.MIN_VALUE);
        return;
      }
      default: {
        throw new AssertionError("Only ten steps allowed."); //$NON-NLS-1$
