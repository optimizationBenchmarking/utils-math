...
public class MatrixIteration2DTestDoubleDoubleDecreasingKeepPreviousSkipSkip4
    extends MatrixIteration2DTest {

  /** create */
  public MatrixIteration2DTestDoubleDoubleDecreasingKeepPreviousSkipSkip4() {
    super();
  }
  ...
  protected void checkY(final int step, final AbstractMatrix y) {
    ...
    switch (step) {
      ...
      case 2: {
        ...
        Assert.assertEquals(999999.5d, y.getDouble(0, 1),
            Double.MIN_VALUE);
        Assert.assertEquals(888888.5d, y.getDouble(0, 2),
            Double.MIN_VALUE);
        return;
      }
      case 3: {
      ...
      case 7: {
        ...
        Assert.assertEquals(88.5d, y.getDouble(0, 2), Double.MIN_VALUE);
        return;
      }
      case 8: {
        Assert.assertEquals(y.n(), 2);
        Assert.assertEquals(99.5d, y.getDouble(0, 0), Double.MIN_VALUE);
