...
public class MatrixIteration2DTestDoubleDoubleIncreasingKeepPreviousSkipSetToValue3
    extends MatrixIteration2DTest {

  /** create */
  public MatrixIteration2DTestDoubleDoubleIncreasingKeepPreviousSkipSetToValue3() {
    super();
  }
  ...
  protected void setup(final MatrixIteration2DBuilder builder) {
    builder.setEndReplacement(Double.valueOf(27.5d));
  ...
  protected void checkY(final int step, final AbstractMatrix y) {
    ...
    switch (step) {
      ...
      case 13: {
        Assert.assertEquals(y.n(), 4);
        Assert.assertEquals(27.5d, y.getDouble(0, 0), Double.MIN_VALUE);
      ...
      case 14: {
        Assert.assertEquals(y.n(), 4);
        Assert.assertEquals(27.5d, y.getDouble(0, 0), Double.MIN_VALUE);
        Assert.assertEquals(27.5d, y.getDouble(0, 1), Double.MIN_VALUE);
      ...
      case 15: {
        ...
        Assert.assertEquals(27.5d, y.getDouble(0, 0), Double.MIN_VALUE);
        Assert.assertEquals(27.5d, y.getDouble(0, 1), Double.MIN_VALUE);
        Assert.assertEquals(27.5d, y.getDouble(0, 2), Double.MIN_VALUE);
