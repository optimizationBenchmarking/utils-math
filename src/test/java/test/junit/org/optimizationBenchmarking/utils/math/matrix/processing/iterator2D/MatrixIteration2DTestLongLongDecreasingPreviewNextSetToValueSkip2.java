...
public class MatrixIteration2DTestLongLongDecreasingPreviewNextSetToValueSkip2
    extends MatrixIteration2DTest {

  /** create */
  public MatrixIteration2DTestLongLongDecreasingPreviewNextSetToValueSkip2() {
    super();
  }
  ...
  protected void setup(final MatrixIteration2DBuilder builder) {
    ...
    builder.setStartReplacement(Long.valueOf(74L));
  ...
  protected void checkY(final int step, final AbstractMatrix y) {
    ...
    switch (step) {
      case 0: {
        ...
        Assert.assertEquals(74L, y.getLong(0, 0));
        Assert.assertEquals(74L, y.getLong(0, 1));
        Assert.assertEquals(999999L, y.getLong(0, 2));
        Assert.assertEquals(74L, y.getLong(0, 3));
        return;
      }
      case 1: {
        Assert.assertEquals(y.n(), 4);
        ...
        Assert.assertEquals(888888L, y.getLong(0, 3));
        return;
      }
      case 2: {
        Assert.assertEquals(y.n(), 4);
