...
public class MatrixIteration2DTestDoubleDoubleIncreasingPreviewNextSetToValueSkip2
    extends MatrixIteration2DTest {

  /** create */
  public MatrixIteration2DTestDoubleDoubleIncreasingPreviewNextSetToValueSkip2() {
    super();
  }
  ...
  protected void setup(final MatrixIteration2DBuilder builder) {
    ...
    builder.setStartReplacement(Double.valueOf(-333.5d));
  ...
  protected void checkY(final int step, final AbstractMatrix y) {
    ...
    switch (step) {
      case 0: {
        ...
        Assert.assertEquals(-333.5d, y.getDouble(0, 1), Double.MIN_VALUE);
        Assert.assertEquals(-333.5d, y.getDouble(0, 2), Double.MIN_VALUE);
        Assert.assertEquals(-333.5d, y.getDouble(0, 3), Double.MIN_VALUE);
        return;
      }
      case 1: {
        Assert.assertEquals(y.n(), 4);
