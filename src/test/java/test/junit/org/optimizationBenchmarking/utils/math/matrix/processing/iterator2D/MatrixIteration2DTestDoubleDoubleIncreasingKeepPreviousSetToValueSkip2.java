...
public class MatrixIteration2DTestDoubleDoubleIncreasingKeepPreviousSetToValueSkip2
    extends MatrixIteration2DTest {

  /** create */
  public MatrixIteration2DTestDoubleDoubleIncreasingKeepPreviousSetToValueSkip2() {
    super();
  }
  ...
  protected void setup(final MatrixIteration2DBuilder builder) {
    ...
    builder.setStartReplacement(Double.valueOf(678.5d));
  ...
  protected void checkY(final int step, final AbstractMatrix y) {
    ...
    switch (step) {
      case 0: {
        ...
        Assert.assertEquals(678.5d, y.getDouble(0, 1), Double.MIN_VALUE);
        Assert.assertEquals(678.5d, y.getDouble(0, 2), Double.MIN_VALUE);
        Assert.assertEquals(678.5d, y.getDouble(0, 3), Double.MIN_VALUE);
        return;
      }
      case 1: {
        Assert.assertEquals(y.n(), 4);
      ...
      case 13: {
        ...
        Assert.assertEquals(100000.5d, y.getDouble(0, 1),
            Double.MIN_VALUE);
        Assert.assertEquals(11000000.5d, y.getDouble(0, 2),
            Double.MIN_VALUE);
        return;
      }
      case 14: {
        ...
        Assert.assertEquals(140000.5d, y.getDouble(0, 0),
            Double.MIN_VALUE);
        Assert.assertEquals(11000000.5d, y.getDouble(0, 1),
            Double.MIN_VALUE);
        return;
      }
      case 15: {
