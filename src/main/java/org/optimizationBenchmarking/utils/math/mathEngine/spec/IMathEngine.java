...
public interface IMathEngine extends IToolJob, Closeable {
   ...
   *          the variable value
   */
  public abstract void setDouble(final String variable,
      final double value);
   ...
   *          the variable value
   */
  public abstract void setMatrix(final String variable,
      final IMatrix value);
   ...
   *          the variable value
   */
  public abstract void setVector(final String variable,
      final IMatrix value);
