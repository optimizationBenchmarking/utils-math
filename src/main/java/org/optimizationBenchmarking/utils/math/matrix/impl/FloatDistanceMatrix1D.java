 ...
 * one-dimensional array of {@code float}.
 */
public final class FloatDistanceMatrix1D extends DistanceMatrix {
   ...
   *          the m
   */
  public FloatDistanceMatrix1D(final float[] data, final int m) {
    super(m);
  ...
  public final AbstractMatrix asRowVector() {
    return new FloatMatrix1D(this.m_data, 1, this.m_data.length);
  }
}
