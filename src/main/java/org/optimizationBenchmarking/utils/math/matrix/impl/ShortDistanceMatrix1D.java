 ...
 * one-dimensional array of {@code short}.
 */
public final class ShortDistanceMatrix1D extends DistanceMatrix {
   ...
   *          the m
   */
  public ShortDistanceMatrix1D(final short[] data, final int m) {
    super(m);
  ...
  public final AbstractMatrix asRowVector() {
    return new ShortMatrix1D(this.m_data, 1, this.m_data.length);
  }
}
