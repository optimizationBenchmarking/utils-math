 ...
 * one-dimensional array of {@code long}.
 */
public final class LongDistanceMatrix1D extends DistanceMatrix {
   ...
   *          the m
   */
  public LongDistanceMatrix1D(final long[] data, final int m) {
    super(m);
  ...
  public final AbstractMatrix asRowVector() {
    return new LongMatrix1D(this.m_data, 1, this.m_data.length);
  }
}
