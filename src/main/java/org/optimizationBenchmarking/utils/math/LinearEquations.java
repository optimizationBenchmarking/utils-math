...
public class LinearEquations {
  ...
  private static final int DECOMPOSE_CHOLESKY = (LinearEquations.DECOMPOSE_LU
      + 1);
  /** the QR decomposition */
  private static final int DECOMPOSE_QR = (LinearEquations.DECOMPOSE_CHOLESKY
      + 1);
  /** the Eigen value decomposition */
  private static final int DECOMPOSE_EIGEN = (LinearEquations.DECOMPOSE_QR
      + 1);
  /** the SVD decomposition */
  private static final int DECOMPOSE_SVD = (LinearEquations.DECOMPOSE_EIGEN
      + 1);
  ...
  public static final double linearEquationsSolve(final double[][] A,
    ...
    loop: for (index = LinearEquations.DECOMPOSE_SVD; (--index) >= LinearEquations.DECOMPOSE_LU;) {
  ...
  public static final double linearEquationsError(final double[][] A,
    ...
    for (i = N; (--i) >= 0;) {
      ...
      outerSum[i] = Math.abs(AddN.destructiveSum(innerSum));
    }
    result = Math.abs(AddN.destructiveSum(outerSum));
    if (result != result) {
