...
final class _Compound2x4 extends QuaternaryFunction
  ...
  /** {@inheritDoc} */
  @Override
  public final _Compound2x4 clone() {
    ...
    if ((result != this.m_result) || (child1 != this.m_child1)
      ...
      return new _Compound2x4(result, child1, child2);
    }
    return this;
  }
  ...
  /** {@inheritDoc} */
  @Override
  public final __Compound2x4Iterator iterator() {
    return new __Compound2x4Iterator();
  }
   ...
   */
  private final class __Compound2x4ParameterRenderer
    ...
    public final boolean equals(final Object o) {
      ...
      if (o instanceof __Compound2x4ParameterRenderer) {
        ...
        return ((this.m_renderer.equals(other.m_renderer))
            && (_Compound2x4.this.equals(other.__getOwner())));
      }
      return false;
    }
  }
  ...
  private final class __Compound2x4Iterator extends BasicIterator<Object> {
    /** the index */
    private int m_index;

    /** create */
    __Compound2x4Iterator() {
      super();
    }
    ...
    public final Object next() {
      switch (this.m_index++) {
        case 0: {
          return _Compound2x4.this.m_result;
        }
        case 1: {
          return _Compound2x4.this.m_child1;
        }
        case 2: {
          return _Compound2x4.this.m_child2;
        }
        default: {
          return super.next();
        }
