...
final class _Compound1x4 extends QuaternaryFunction
  ...
  /** {@inheritDoc} */
  @Override
  public final __Compound1x4Iterator iterator() {
    return new __Compound1x4Iterator();
  }
  ...
  private final class __Compound1x4Iterator extends BasicIterator<Object> {
    /** the index */
    private int m_index;

    /** create */
    __Compound1x4Iterator() {
      super();
    }
    ...
    public final Object next() {
      switch (this.m_index++) {
        case 0: {
          return _Compound1x4.this.m_result;
        }
        case 1: {
          return _Compound1x4.this.m_child1;
        }
        default: {
          return super.next();
        }
