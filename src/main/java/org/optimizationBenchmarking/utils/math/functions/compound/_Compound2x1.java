...
final class _Compound2x1 extends UnaryFunction
  ...
  /** {@inheritDoc} */
  @Override
  public final _Compound2x1 clone() {
    ...
    if ((result != this.m_result) || (child1 != this.m_child1)
      ...
      return new _Compound2x1(result, child1, child2);
    }
    return this;
  }
  ...
  /** {@inheritDoc} */
  @Override
  public final __Compound2x1Iterator iterator() {
    return new __Compound2x1Iterator();
  }
   ...
   */
  private final class __Compound2x1ParameterRenderer
    ...
    public final boolean equals(final Object o) {
      ...
      if (o instanceof __Compound2x1ParameterRenderer) {
        ...
        return ((this.m_renderer.equals(other.m_renderer))
            && (_Compound2x1.this.equals(other.__getOwner())));
      }
      return false;
    }
  }
  ...
  private final class __Compound2x1Iterator extends BasicIterator<Object> {
    /** the index */
    private int m_index;

    /** create */
    __Compound2x1Iterator() {
      super();
    }
    ...
    public final Object next() {
      switch (this.m_index++) {
        case 0: {
          return _Compound2x1.this.m_result;
        }
        case 1: {
          return _Compound2x1.this.m_child1;
        }
        case 2: {
          return _Compound2x1.this.m_child2;
        }
        default: {
          return super.next();
        }
