...
final class _Compound2x2 extends BinaryFunction
  ...
  /** {@inheritDoc} */
  @Override
  public final _Compound2x2 clone() {
    ...
    if ((result != this.m_result) || (child1 != this.m_child1)
      ...
      return new _Compound2x2(result, child1, child2);
    }
    return this;
  }
  ...
  /** {@inheritDoc} */
  @Override
  public final __Compound2x2Iterator iterator() {
    return new __Compound2x2Iterator();
  }
   ...
   */
  private final class __Compound2x2ParameterRenderer
    ...
    public final boolean equals(final Object o) {
      ...
      if (o instanceof __Compound2x2ParameterRenderer) {
        ...
        return ((this.m_renderer.equals(other.m_renderer))
            && (_Compound2x2.this.equals(other.__getOwner())));
      }
      return false;
    }
  }
  ...
  private final class __Compound2x2Iterator extends BasicIterator<Object> {
    /** the index */
    private int m_index;

    /** create */
    __Compound2x2Iterator() {
      super();
    }
    ...
    public final Object next() {
      switch (this.m_index++) {
        case 0: {
          return _Compound2x2.this.m_result;
        }
        case 1: {
          return _Compound2x2.this.m_child1;
        }
        case 2: {
          return _Compound2x2.this.m_child2;
        }
        default: {
          return super.next();
        }
