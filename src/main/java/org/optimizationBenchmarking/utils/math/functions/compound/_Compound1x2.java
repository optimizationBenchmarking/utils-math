...
final class _Compound1x2 extends BinaryFunction
  ...
  /** {@inheritDoc} */
  @Override
  public final __Compound1x2Iterator iterator() {
    return new __Compound1x2Iterator();
  }
   ...
   */
  private final class __Compound1x2ParameterRenderer
    ...
    public final boolean equals(final Object o) {
      ...
      if (o instanceof __Compound1x2ParameterRenderer) {
        ...
        return ((this.m_renderer.equals(other.m_renderer))
            && (_Compound1x2.this.equals(other.__getOwner())));
      }
      return false;
    }
  }
  ...
  private final class __Compound1x2Iterator extends BasicIterator<Object> {
    /** the index */
    private int m_index;

    /** create */
    __Compound1x2Iterator() {
      super();
    }
    ...
    public final Object next() {
      switch (this.m_index++) {
        case 0: {
          return _Compound1x2.this.m_result;
        }
        case 1: {
          return _Compound1x2.this.m_child1;
        }
        default: {
          return super.next();
        }
