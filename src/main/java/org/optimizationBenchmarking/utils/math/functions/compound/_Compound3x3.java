...
final class _Compound3x3 extends TernaryFunction
  ...
  public final void mathRender(final IMath out,
    ...
    this.m_result.mathRender(out,
        new __Compound3x3ParameterRenderer(renderer));
  }
  ...
  /** {@inheritDoc} */
  @Override
  public final _Compound3x3 clone() {
    ...
    if ((result != this.m_result) || (child1 != this.m_child1)
      ...
      return new _Compound3x3(result, child1, child2, child3);
    }
    return this;
  }
  ...
  /** {@inheritDoc} */
  @Override
  public final __Compound3x3Iterator iterator() {
    return new __Compound3x3Iterator();
  }
   ...
   */
  private final class __Compound3x3ParameterRenderer
    ...
    public final boolean equals(final Object o) {
      ...
      if (o instanceof __Compound3x3ParameterRenderer) {
        ...
        return ((this.m_renderer.equals(other.m_renderer))
            && (_Compound3x3.this.equals(other.__getOwner())));
      }
      return false;
    }
  }
  ...
  private final class __Compound3x3Iterator extends BasicIterator<Object> {
    /** the index */
    private int m_index;

    /** create */
    __Compound3x3Iterator() {
      super();
    }
    ...
    public final Object next() {
      switch (this.m_index++) {
        case 0: {
          return _Compound3x3.this.m_result;
        }
        case 1: {
          return _Compound3x3.this.m_child1;
        }
        case 2: {
          return _Compound3x3.this.m_child2;
        }
        case 3: {
          return _Compound3x3.this.m_child3;
        }
        default: {
          return super.next();
        }
