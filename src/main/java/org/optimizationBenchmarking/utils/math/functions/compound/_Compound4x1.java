...
final class _Compound4x1 extends UnaryFunction
  ...
  /** {@inheritDoc} */
  @Override
  public final __Compound4x1Iterator iterator() {
    return new __Compound4x1Iterator();
  }
  ...
  private final class __Compound4x1Iterator extends BasicIterator<Object> {
    /** the index */
    private int m_index;

    /** create */
    __Compound4x1Iterator() {
      super();
    }
    ...
    public final Object next() {
      switch (this.m_index++) {
        case 0: {
          return _Compound4x1.this.m_result;
        }
        case 1: {
          return _Compound4x1.this.m_child1;
        }
        case 2: {
          return _Compound4x1.this.m_child2;
        }
        case 3: {
          return _Compound4x1.this.m_child3;
        }
        case 4: {
          return _Compound4x1.this.m_child4;
        }
        default: {
          return super.next();
        }
