...
final class _Compound2x3 extends TernaryFunction
  ...
  /** {@inheritDoc} */
  @Override
  public final __Compound2x3Iterator iterator() {
    return new __Compound2x3Iterator();
  }
   ...
   */
  private final class __Compound2x3ParameterRenderer
    ...
    public final boolean equals(final Object o) {
      ...
      if (o instanceof __Compound2x3ParameterRenderer) {
        ...
        return ((this.m_renderer.equals(other.m_renderer))
            && (_Compound2x3.this.equals(other.__getOwner())));
      }
      return false;
    }
  }
  ...
  private final class __Compound2x3Iterator extends BasicIterator<Object> {
    /** the index */
    private int m_index;

    /** create */
    __Compound2x3Iterator() {
      super();
    }
    ...
    public final Object next() {
      switch (this.m_index++) {
        case 0: {
          return _Compound2x3.this.m_result;
        }
        case 1: {
          return _Compound2x3.this.m_child1;
        }
        case 2: {
          return _Compound2x3.this.m_child2;
        }
        default: {
          return super.next();
        }
