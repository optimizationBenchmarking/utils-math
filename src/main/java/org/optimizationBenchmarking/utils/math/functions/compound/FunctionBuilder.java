...
public abstract class FunctionBuilder<T extends MathematicalFunction> {
   ...
   */
  public abstract T compound(final QuaternaryFunction func, final T param1,
      final T param2, final T param3, final T param4);
  ...
  public static final FunctionBuilder<MathematicalFunction> getInstanceForArity(
    ...
    switch (arity) {
      ...
      case 4: {
        return ((FunctionBuilder) (QuaternaryFunctionBuilder
            .getInstance()));
      }
      default: {
        throw new IllegalArgumentException((//
