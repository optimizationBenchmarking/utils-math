...
/**
 * The inverted cumulative distribution function (
 * <a href="http://en.wikipedia.org/wiki/Cumulative_distribution_function"
 * >CDF</a>) of the
 * <a href="http://en.wikipedia.org/wiki/Chi-squared_distribution">Chi-
 * squared (&chi;&sup2;) distribution</a>.
 */
public final class ChiSquareInvCDF extends BinaryFunction {
   ...
   */
  public static final double chiSquareQuantil(final double d,
      final int dof) {
